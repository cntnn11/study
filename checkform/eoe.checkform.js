var eoe = $.extend(eoe, {
	 ...
	 *		EXP： var data_format	= {tit:'', input:'text/textarea/select/checkbox/radio', format: { empty:true, email:false, phone:false, tel:true, len:[0, 30], repeat:{re_id:\'password\', input:\'text\', name_zh:\'密码\'}, ajaxUnique: {url:\'/sso/checkusername.html\', data_name:\'username\'} } };
	 *	
	 */
	...
	methods:{
		...
		len: function(val, params)
		{
			...
			if( unlen >= params[0] && unlen <= params[1] )
			{
				chkForm.showSucc();
			}
			else
